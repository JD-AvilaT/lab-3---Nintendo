class Cereza extends HTMLElement{
    ...
    render(){
        if (this.shadowRoot){
            ...
            <section>
                <img src="https://assets.nintendo.com/image/upload/f_auto/q_auto/c_fill,w_1500/dpr_2.0/ncom/en_US/merchandising/center-stage-banner/bayonetta-origins/3600x1300_BayoOrigins_centerstage_desktop">
                <div class="down">
                    <div class="left">
                        <h2>Resérvalo ya</h2>
                        <p>Más información</p>
